...
%
%	\centering
%	\subfigure[\emph{Accuracy} + reducción]{\label{fig:a}\includegraphics[scale=0.45]{acc_small.png}}
%	\subfigure[\emph{kappa} + reducción]{\label{fig:b}\includegraphics[scale=0.45]{kappa_small.png}}
%
